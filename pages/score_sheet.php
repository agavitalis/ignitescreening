<?php
    ...
    $query = "SELECT *
    FROM score_table  INNER JOIN applicant ON score_table.applicant_id=applicant.id INNER JOIN judges ON score_table.judge_id=judges.id WHERE score_table.score = 2";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Score Scheet</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Ignite Applicants</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example" class="table table-stripped display nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Email</th>
