<?php
    ...
    $query = "SELECT *
    FROM score_table  INNER JOIN applicant ON score_table.applicant_id=applicant.id INNER JOIN judges ON score_table.judge_id=judges.id WHERE score_table.score = 0";
